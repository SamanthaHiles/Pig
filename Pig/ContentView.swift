...
//  Pig
//
//  Created by Samantha Hiles on 10/23/24.
//
            ...
            ZStack {
                ...
                VStack {
                    ...
                    VStack(alignment: .leading) {
                        Text("In the game of Pig, players take individual turns. Each turn, a player rolls a single die until a pig is rolled, or the player decides to \"hold\".")
                            .padding()
                        Text("If a player rolls a pig, they score nothing and it is the next players turn.")
                            .padding()
                        Text("If a player rolls any other number, it is added to their turn in total, and the players turn continues.")
                            .padding()
                        Text("If the player chooses to \"hold\", their turn total is added to the game score, and it becomes the next players turn.")
                            .padding()
                        Text("A player wins when the game score becomes 100 or more on their turn.")
                            .padding()
                    }
                    Spacer()
                }
